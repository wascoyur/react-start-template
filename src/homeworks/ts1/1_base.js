...
export const getBeautifulNumber = (value, separator = ' ') => value === null || value === void 0 ? void 0 : value.toString().replace(/\B(?=(\d{3})+(?!\d))/g, separator);
export const round = (value, accuracy = 2) => {
    const d = Math.pow(10, accuracy);
...
//# sourceMappingURL=1_base.js.map